...
def build_tensorrt_engine(onnx_model_path):
    ...
    for i in range(network.num_inputs):
        ...
        profile.set_shape(name, (1, 128), (8, 128), (32, 128))  # min, opt, max batch size
...
if __name__ == "__main__":
    ...
    batch_size = 32 # wegen optimizer geht erstmal nicht mehr: Set dimension [128,128] for tensor attention_mask does not satisfy any optimization profiles. Valid range for profile 0: [1,128]..[32,128]
    ...
    context=0
    throughput_log, latency_log = calculate_latency_and_throughput(context, batch_sizes, onnx_model_path)
